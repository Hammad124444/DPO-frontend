export const subdescriptions = [
    "Direct Private Offers respects the privacy of our users and has developed this Privacy Policy to demonstrate its commitment to protecting your privacy. This Privacy Policy is intended to describe for you, as an individual who is a user of Direct Private Offers (and all websites and URL's controlled or operated by Direct Private Offers which link to this policy, unless otherwise specified) or our services, or otherwise provide us with information through various means the information we collect, how that information may be used, with whom it may be shared, and your choices about such uses and disclosures.",
...
export const useOfCookies = {
    ...
    details: [
        ...
        '(<Link href="www.networkadvertising.org"><a className="c-green">www.networkadvertising.org.</a></Link>)'
    ]
}

export const useOfInformation = {
    title: 'How we use the information we collect',
    subTitle: '<u>In general.</u> We may use information that we collect about you to:',
    details: [
    ...
    descriptions: [
        '<u>Financial information.</u> For Professionals, we may use financial information or payment methods to process payment for any purchases made on our website, enroll you in the discount, rebate, and other programs in which you elect to participate, other offers that you might find of interest, to pre-qualify Professionals to participate in our directory service, to protect against or identify possible fraudulent transactions, and otherwise as needed to manage our business.',
        '<u>Job applicants.</u> If your personal information is submitted through our website when applying for a position with our company, the information will be used solely in connection with considering and acting upon your application. We may retain your personal information for a period of time, but only for the purpose of considering your application for current or future available positions. This information may be shared with our other companies for the purpose of evaluating your qualifications for the particular position or other available positions, as well as with third-party service providers retained by us to collect, maintain and analyze candidate submissions for job postings.'
    ]
}

export const whomToShare = {
    title: 'With whom we share your information',
    subTitles: 'We want you to understand when and with whom we may share personal or other information we have collected about you or your activities on our web site or while using our services.',
    details: {
        title: '<u>Personal information.</u> <b>We do not share your personal information with others except as indicated below </b> or when we inform you and give you an opportunity to opt out of having your personal information shared. We may share personal information with:',
        contents: [
            ...
            '<b>Professionals.</b> We match your information and service request against our list of Professionals. When you submit a match request through our website, you consent to our providing your personal information and request to the Professionals we match with your request. Sharing this information with Professionals allows them to contact you using the e-mail address or other contact information you provided. In addition, we have other approved contractual partners that fulfill service requests, or that utilize their own Professionals to supplement our network, and we share your information with them, subject to contractual confidentiality restrictions, in order to attempt to provide the services requested. If using our services pursuant to a membership with one of our partners, Direct Private Offers may share your service request activity information with such partner. We may also release information to collection and/or credit agencies for past due Professional accounts.',
            '<b>Direct mail partners.  We DO NOT share our postal mailing list.</b>',
            '<b>Other Situations.</b> We also may disclose your information:',
...
export const yourChoices = {
    ...
    contents: [
        ...
        'If you prefer not to have us share your postal mailing information with these selected providers of goods and services that may be of interest to you, you can notify us at any time by emailing us at service@directprivateoffers.com.'
    ]
}

export const protectInformation = {
    ...
    descriptions: [
        ...
        'We want you to feel confident using our website to transact business. However, no system can be completely secure. Therefore, although we take steps to secure your information, we do not promise, and you should not expect, that your personal information, searches, or other communications will always remain secure. Please refer to the Federal Trade Commission\'s website at<Link href="http://www.ftc.gov/bcp/menus/consumer/data.shtm"><a className="c-green"> http://www.ftc.gov/bcp/menus/consumer/data.shtm</a></Link> for information about how to protect yourself against identity theft.'
    ]
}